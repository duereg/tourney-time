...
const firstDivision: Division = ['1st Pod 1', '1st Pod 2', '1st Pod 3'];

const secondDivision: Division = ['2nd Pod 1', '2nd Pod 2', '2nd Pod 3'];

const thirdDivision: Division = ['3rd Pod 1', '3rd Pod 2', '3rd Pod 3'];
