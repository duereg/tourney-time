...
describe 'tourney/round-robin', ->
  ...
  describe 'given number of teams', ->
    ...
    describe 'given 2 teams', ->
      ...
      it 'returns correct schedule', ->
        expect(schedule).to.eql [{id:10,round:1,teams:[2,1]}]
    ...
    describe 'given 3 teams', ->
      ...
      it 'returns correct schedule', ->
        expect(schedule).to.eql [{id:10,round:1,teams:[3,2]},{id:20,round:2,teams:[1,3]},{id:30,round:3,teams:[2,1]}]
  ...
  describe 'given team names', ->
    ...
    it 'given 2 teams returns 2 games with correct names', ->
      expect(roundRobin(['a', 'b'])).to.eql { games: 1, schedule: [{id:10,round:1,teams: ['b','a']}],teams: ['a', 'b'] }
    ...
    describe 'given 3 teams', ->
      ...
      it 'returns correct schedule', ->
        expect(schedule).to.eql [{id:10,round:1, teams: ['c','b']}, {id:20, round:2, teams: ['a','c']}, {id:30, round:3, teams: ['b','a']}]
